...
const changeActive = (path: string) => {
  $router.push({path, query: {code: $route.query.code}})
}

onMounted(() => {
  detailStore.getHospitalInfo($route.query.code as string)
  detailStore.getHospitalDepartment($route.query.code as string)
})
